...
namespace Optim::diff {
    ...
    class Diff {
        static void forward_diff_impl(base::FuncType func, base::InputType x, base::InputType h) -> base::OutputType {
        ...
        static void backward_diff_impl(base::FuncType func, base::InputType x, base::InputType h) -> base::OutputType {

        }

        static void central_diff_impl(base::FuncType func, base::InputType x, base::InputType h) -> base::OutputType {

        }

        static void dispatcher(const ForwardDiff tag, const base::FuncType& func, base::InputType x, base::InputType h) -> base::OutputType {
            static_cast<void>(tag);
            return forward_diff_impl(func, x, h);
        };

        static void dispatcher(BackWardDiff tag, base::FuncType func, base::InputType x, base::InputType h) -> base::OutputType {
            static_cast<void>(tag);
            return backward_diff_impl(func, x, h);
        }

        static void dispatcher(CentralDiff tag, base::FuncType func, base::InputType x, base::InputType h) {
            static_cast<void>(tag);
            return central_diff_impl(func, x, h);
        }
    public:
        template<ValidDiffTag Tag>
        static auto eval(base::FuncType func, base::InputType x, base::InputType h) {
